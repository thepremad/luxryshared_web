        ...
        <div class="row justify-content-center">
            <div class="col-lg-8 col-md-8 col-sm-8 col-8">
                <div class="sectionOtp-outer text-center">
                    ...
                    <form class="otp-form">
                        <input type="number" class="otp-input" maxlength="1" min="0" max="9" id="otp1" />
                        <input type="number" class="otp-input" maxlength="1" min="0" max="9" id="otp2" />
                        <input type="number" class="otp-input" maxlength="1" min="0" max="9" id="otp3" />
                        <input type="number" class="otp-input" maxlength="1" min="0" max="9" id="otp4" />
                    </form>
                    <p>A verification code has been sent to your email, please also check your junk folder.</p>
                    <button class="btn btn-primary mt-4">Verify</button>
                </div>
            </div>                    
        </div>
    </div>
