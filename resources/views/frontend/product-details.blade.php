            ...
            <div class="product-single">
                <div class="row">
                    <div class="col-lg-7 col-md-7 col-sm-12 col-12">
                        ...
                        <form action="{{route('checkout_details')}}" method="post">
                            @csrf
                            <div class="slider">
                            ...
                            <div class="accordion-item">
                                ...
                                <div id="collapseOne" class="accordion-collapse collapse show"
                                    ...
                                    <div class="accordion-body">
                                        ...
                                        <div class="rent-package mb-3">
                                            ...
                                            <div class="row mb-5">
                                                <div class="col-xl-3 col-lg-3 col-sm-3 col-6 plan">
                                                    <div class="plan-card">
                                                        <input type="radio" id="plan1" name="plan" value="plan1"
                                                            class="plan-radio">
                                                        <label for="plan1">
                                                ...
                                                <div class="col-xl-3 col-lg-3 col-sm-3 col-6 plan">
                                                    <div class="plan-card">
                                                        ...
                                                        <label for="plan2">
                                                            <h4 class="days">4 Days</h4>
                                                            <h5 class="price">{{$item->sevenToTwentyNineDayPrice ?? ''}}
                                                            </h5>
                                                            <h6 class="priceDay">$15.57/Day</h6>
                                                        </label>
                                                    </div>
                                        ...
                                        <input type="hidden" name="id" value="{{$item->id}}" id="item__id">
                                        <div class="rent-submit mb-4">
                                            <button type="submit" class="btn btn-dark">RENT NOW</button>
                                        </div>
                                        <div class="rent-days">
                                            <h5>Dates*</h5>
                ...
                <div class="col-lg-6 col-md-6 col-sm-6 col-12 desc-col1">
                    ...
                    <ul class="nav nav-tabs" id="myTab" role="tablist">
                        ...
                        <li class="nav-item" role="presentation">
                            <a class="nav-link" id="reviews-tab" data-bs-toggle="tab" href="#reviews" role="tab"
                                aria-controls="reviews" aria-selected="false">Reviews <span
                                    Class="productReview-num">4</span></a>
                        </li>
                    </ul>
                    ...
                    <div class="tab-content" id="myTabContent">
                        ...
                        <div class="tab-pane fade" id="reviews" role="tabpanel" aria-labelledby="reviews-tab">
                            <p>100% Bio-washed Cotton – makes the fabric extra soft & silky. Flexible ribbed crew neck.
                                Precisely stitched with no pilling & no fading. Provide all-time comfort. Anytime,
                                anywhere. Infinite range of matte-finish HD prints.</p>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="row">
                        <div class="col-6 col-sm-6 col-md-3 col-lg-3">
                            <div class="collection-grid-item text-center">
                                <a href="collection-page.html" class="collection-grid-item__link">
                                    <img data-src="{{asset('assets/img/Rectangle 26.png')}}"
                        ...
                        <div class="col-6 col-sm-6 col-md-3 col-lg-3">
                            <div class="collection-grid-item text-center">
                                <a href="collection-page.html" class="collection-grid-item__link">
                                    <img data-src="{{asset('assets/img/Rectangle 26.png')}}"
                                        src="{{asset('assets/img/Rectangle 26.png')}}" alt="Denim"
                                        class="blur-up blur-active ls-is-cached lazyloaded">
                        ...
                        <div class="col-6 col-sm-6 col-md-3 col-lg-3">
                            <div class="collection-grid-item text-center">
                                <a href="collection-page.html" class="collection-grid-item__link">
                                    <img data-src="{{asset('assets/img/Rectangle 26.png')}}"
                                        src="{{asset('assets/img/Rectangle 26.png')}}" alt="Summer"
                                        class="blur-up ls-is-cached lazyloaded">
