<footer id="footer" class="footer">
                <div class="container-fluid">
                    <div class="row">
                        <div class="col-lg-3 col-md-3 col-sm-3 col-12 footer-column" id="footer-col1">
                            ...
                            <p>Sign up to our newsletter and receive
                                exclusive, news, offers and discounts:</p>
                        ...
                        <div class="col-lg-3 col-md-3 col-sm-3 col-12 footer-column" id="footer-col5">
                            ...
                            <ul class="footer-links" id="socialLinks">
                                <li>
                                    <a href="#" target="_blank">
                                        <img src="{{asset('frontend/assets/images/social-icon/instagram.png')}}" alt="">
                                    </a>
                                </li>
                                <li>
                                    <a href="#" target="_blank">
                                        <img src="{{asset('frontend/assets/images/social-icon/facebook.png')}}" alt="">
                                    </a>
                                </li>
                                <li>
                                    <a href="#" target="_blank">
                                        <img src="{{asset('frontend/assets/images/social-icon/twitter.png')}}" alt="">
                                    </a>
                                </li>
                                <li>
                                    <a href="#" target="_blank">
                                        <img src="{{asset('frontend/assets/images/social-icon/Pintraste.png')}}" alt="">
                                    </a>
                                </li>
                                <li>
                                    <a href="#" target="_blank">
                                        <img src="{{asset('frontend/assets/images/social-icon/tiktok.png')}}" alt="">
                                    </a>
                                </li>
                                <li>
                                    <a href="#" target="_blank">
                                        <img src="{{asset('frontend/assets/images/social-icon/youtube.png')}}" alt="">
                                    </a>
                                </li>
                            </ul>
                            ...
                            <ul id="application-link">
                                <li>
                                    <a href="#" target="_blank">
                                        <img src="{{asset('frontend/assets/images/social-icon/image 36.png')}}" alt="">
                                    </a>
                                </li>
                            </ul>
                        </div>
                    ...
                    <div class="row copyrigt-row">
                        <p>Copyright © 2021 <a href="">LXRY Shared</a>. All Right Reserved. Created by CreateME</p>
                    </div>
                </div>
            </footer>
            <!-- End Footer -->
                                    ...
                                    <div class="row">
                                        <div class="col-lg-6 col-md-6 col-sm-12 col-12">
                                            <div class="product-details-img">
                                                <div class="pl-20">
                                                    <img src="{{asset('frontend/assets/images/product-detail-page/camelia-reversible-big1.jpg')}}"
                                                        alt />
                                                </div>
                                            </div>
                                        </div>
            ...
            <div class="newsletter-wrap" id="popup-container">
                <div id="popup-window">
                    ...
                    <div class="display-table splash-bg">
                        <div class="display-table-cell width40"><img src="{{asset('frontend/assets/images/newsletter-img.jpg')}}"
