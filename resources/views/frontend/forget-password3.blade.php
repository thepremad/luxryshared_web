                ...
                <div class="loginRegister-section">
                    ...
                    <div class="row formRow update">
                        <div class="col-md-7 col-lg-7 register-tabSection">
                            ...
                            <div class="card">
                                <div class="card-body">
                                    <form id="multiStepForm" action="{{ route('new_password',$user->id) }}" method="post">
                                        @csrf
                                        <h3>Change Password</h3>
                                        <div class="form-group password-wrapper">
                                            <label for="newPassword">Create New Password</label>
                                            <input type="password" name="password" class="form-control" id="newPassword" placeholder="Create new password">
