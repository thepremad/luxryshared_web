        ...
        <div class="container mt-4">
            ...
            <div class="row banner-section">
                <div class="col-xl-2 col-lg-2 col-md-2 col-sm-2 col-2">
                    <img src="{{ asset('assets/images/userProfile/profile_img.png') }}" alt="User Image"
                    ...
                    <ul class="sidebar-nav">
                        ...
                        <li>
                            <a href="#" data-target="#renting">
                                <img src="{{ asset('assets/images/icons/Rating.svg') }}" class="editProfile-icon"
                                    alt="Renting" />
                                Renting
                            </a>
                        </li> --}}
                        ...
                        <li>
                            <a href="#" data-target="#lending">
                                <img src="{{ asset('assets/images/icons/Leading.svg') }}" class="editProfile-icon"
                                    alt="Lending" />
                                Lending
                            </a>
                        </li>
                        ...
                        <li>
                            <a href="#" data-target="#resale">
                                <img src="{{ asset('assets/images/icons/Resale.svg') }}" class="editProfile-icon"
                                    alt="Resale" />
                                Resale
                            </a>
                        </li>
{{-- 
                        ...
                        <li>
                            <a href="#" data-target="#reviews">
                                <img src="{{ asset('assets/images/icons/Review.svg') }}" class="editProfile-icon"
                                    alt="Reviews" />
                                Reviews
                            </a>
                        </li>
                                            ...
                                            @foreach ($rentingData as $val)
                                                <tr>
                                                    <td class="border-0 px-3">
                                                        <img width="70px"
                                                            src="{{ asset('uploads/item/' . $val->products->mainImag) }}"
                                                            alt="">
                                                    </td>
                                                    <td class="border-0 px-3 font-weight-bold">
                                                        {{ $val->products->item_title ?? '' }}</td>
                                                    <td class="border-0 px-3 font-weight-bold">
                                                        {{ $val->users->first_name ?? '' }}</td>
                                                    <td class="border-0 px-3 font-weight-bold">
                                                        {{ $val->products->rrp_price ?? '' }}</td>
                                                    <td class="border-0 px-3">
                                                                        ...
                                                                        <div class="modal rateModal">
                                                                            <div class="modal-content">
                                                                                <form class="ratingForm"
                                                                                    action="{{ route('rating_item') }}"
                                                                                    method="POST"
                                                                                    id="rating_renting_{{ $val->id }}">
                                                                                    <label for="rating">Rate the Item:
                                                                                        Rate
                                                                                        Item</label>
                                                                                    ...
                                                                                    <label for="review">Review
                                                                                        Item:</label>
                                                                                    <textarea class="review" placeholder="Write your review" rows="5" style="width: 100%;"></textarea>
                                                                                    <button type="submit"
                                                                                ...
                                                                                <script>
                                                                                    $(document).ready(function() {
                                                                                        ...
                                                                                        $('#rating_renting_').on('submit', function(e) {
                                                                                            
                                                                                            $('#pre-loader').show();
                                                                            
                                                                                            e.preventDefault(); // Prevent the default form submission
                                                                                            // var $form = $("#rating_renting_${$}");
                                                                ...
                                                                <div class="card border-0">
                                                                    <div class="card-body">
                                                                        ...
                                                                        <div class="modal rateModal">
                                                                            <div class="modal-content">
                                                                                <form class="ratingForm">
                                                                                    <label for="rating">Rate the Lender:
                                                                                        Rate
                                                                                        Lender</label>
                                                                                    <div class="star-rating">
                                                                                        <span class="star"
                                            ...
                                            @foreach ($lendingData as $val)
                                                <tr>
                                                    ...
                                                    <td class="border-0 px-3 font-weight-bold">
                                                        {{ $val->products->item_title ?? '' }}</td>
                                                    <td class="border-0 px-3 font-weight-bold">
                                                        {{ $val->products->users->first_name ?? '' }}</td>
                                                    <td class="border-0 px-3 font-weight-bold">
                                                        {{ $val->products->rrp_price ?? '' }}</td>
                                                    <td class="border-0 px-3">
                                                        <a href="#" class="details-toggle">Details</a>
                                                ...
                                                <tr class="details-content">
                                                    <td colspan="5" class="border-0 pt-0 pb-4">
                                                        ...
                                                        <div class="row btn-row">
                                                            <div class="col-lg-4">
                                                                <button class="btn btn-primary openModal"
                                                                    data-target="rateRentorModal_{{ $val->id }}">Rate
                                                                    Rentor</button>
                                                            </div>
                                                            <div class="col-lg-4">
                                                                <button class="btn btn-primary openModal"
                                                            ...
                                                            <div class="col-lg-4">
                                                                <a href="{{ route('withdrawl_request', $val->id) }}"><button
                                                                        class="btn btn-primary openModal"
                                                                        data-target="withdrawalModal">Request
                                                                        Withdrawal</button></a>
                                                            </div>
                                                        </div>

                                                        <!-- Rate Rentor Modal -->
                                                        <div id="rateRentorModal_{{ $val->id }}" class="modal">
                                                            <div class="modal-content">
                                                                <form id="ratingFormRentor_{{ $val->id }}"
                                                                    action="{{ route('rating_item') }}">
                                                                    <label for="rating">Rate the Rentor: Rate
                                                                        Rentor</label>
                                                                    ...
                                                                    <textarea id="review" placeholder="Write your review" rows="10" style="width: 100%;"></textarea>
                                                                    <button type="submit"
                                                        ...
                                                        <div id="withdrawalModal" class="modal">
                                                            <div class="modal-content">
                                                                <form id="ratingFormItem">
                                                                    <label for="rating">Rate the Item:Request
                                                                        Withdrawal</label>
                                                                    <div id="stars" class="star-rating">
                                                                        <span class="star" data-value="1"><i
                                                                                class="fa-regular fa-star"></i></span>
                                    ...
                                    <div class="col-xl-4 col-lg-4 col-md-4 col-sm-6 col-12 mb-4 selling-card">
                                        <div class="card border-0">
                                            <img src="{{ asset('uploads/item/' . $val->products->mainImag) }}"
                                                class="card-img-top mb-4" alt="Product Image">
                                        ...
                                        <table class="table">
                                            <tbody>
                                                <tr>
                                                    ...
                                                    <td class="border-0 px-0 font-weight-bold">
                                                        {{ $val->products->item_title ?? '' }}</td>
                                                </tr>
                                                <tr>
                                                    <td class="border-0 px-0">Brand:</td>
                                                    <td class="border-0 px-0 font-weight-bold">
                                                        {{ $val->products->brand->name ?? '' }}</td>
                                                </tr>
                                                <tr>
                                                    <td class="border-0 px-0">Color:</td>
                                                    <td class="border-0 px-0 font-weight-bold">
                                                        {{ $val->products->color->name }}</td>
                                                </tr>
                                                <tr>
                                                    <td class="border-0 px-0">Size:</td>
                                                    <td class="border-0 px-0 font-weight-bold">
                                                        {{ $val->products->size->name ?? '' }}</td>
                                                </tr>
                                            </tbody>
                                        </table>
                                    </div>
                                    ...
                                    <form method="post" action="{{ route('edit_web_profile') }}">
                                        ...
                                        <div class="row">
                                            <div class="col-md-6 mb-3">
                                                ...
                                                <input type="text" value="{{ auth()->user()->first_name }}"
                                                    name="first_name" class="form-control" id="firstName">
                                                <span class="text text-danger"
                                                    id="wakoo">{{ $errors->first('first_name') }}</span>
                                            ...
                                            <div class="col-md-6 mb-3">
                                                ...
                                                <input type="text" name="last_name"
                                                    ...
                                                    id="lastName">
                                                <span class="text text-danger"
                                                    id="wakoo">{{ $errors->first('last_name') }}</span>
                                        ...
                                        <div class="row">
                                            <div class="col-md-6 mb-3">
                                                ...
                                                <span class="text text-danger"
                                                    id="wakoo">{{ $errors->first('email') }}</span>

                                            </div>
                                            <div class="col-md-6 mb-3">
                                                <label for="mobile">Mobile Number</label>
                                                <input type="number" name="number"
                                                    value="{{ auth()->user()->number }}" class="form-control"
                                                    id="mobile">
                                                <span class="text text-danger"
                                                    id="wakoo">{{ $errors->first('number') }}</span>
                                        ...
                                        <div class="row">
                                            <div class="col-md-6 mb-3">
                                                ...
                                                <input type="password" name="password" class="form-control"
                                                    id="password">
                                                <span class="text text-danger"
                                                    id="wakoo">{{ $errors->first('password') }}</span>

                                            </div>
                                            <div class="col-md-6 mb-3 d-flex justify-content-start align-items-center">
                                                <div class="upload-circle-outer">
                                                    <div class="upload-circle">
                                                        <input required type="file" name="id_image" accept="image/*"
                                                            id="fileUpload" class="custom-file-upload"
                                        ...
                                        <div class="row">
                                            <div class="col-md-6 mb-3">
                                                ...
                                                <input type="url" name="facebook"
                                                    value="{{ auth()->user()->facebook }}" class="form-control"
                                                    id="facebook">
                                            </div>
                                            <div class="col-md-6 mb-3">
                                                <label for="instagram">Instagram</label>
                                                <input type="url" name="instagram" class="form-control"
                                                    value="{{ auth()->user()->instagram }}" id="instagram">
                                            </div>
                                        </div>
                                        <div class="row">
                                            <div class="col-md-6 mb-3">
                                                ...
                                                <input type="url" name="twitter"
                                                    value="{{ auth()->user()->twitter }}" class="form-control"
                                                    id="twitter">
                                            </div>
                                            <div class="col-md-6 mb-3">
                                                <label for="tiktok">TikTok</label>
                                                <input type="url" name="tiktok" class="form-control"
                                                    value="{{ auth()->user()->tiktok }}" id="tiktok">
                                            </div>
                                        </div>
                            ...
                            <div class="row justify-content-start py-4">
                                <div class="col-12 mb-4 referFriend">
                                    <div class="row flex-column">
                                        ...
                                        <p>Introduce a friend to LXRY Shared and get AED 50 , they’ll will also get AED 50
                                            their
                                            first rental.</p>
                                        ...
                                        <div class="row justify-content-end py-5">
                                            <div class="col-xl-4 col-lg-4 col-md-4 col-sm-4 col-4">
                                                <button class="btn btn-lg"
                                                    onclick="copyText('{{ auth()->user()->refer_code }}')">Copy</button>
                                            </div>
                                        </div>
                                        ...
                                        <div class="row justify-content-start mb-5">
                                            <div class="row justify-content-start">
                                                ...
                                                <a href="https://www.twitter.com" target="_blank"
                                                    class="social-icon mr-3">
                                                    <img src="{{ asset('assets/images/icons/Instagram.svg') }}"
                                                        alt="Instagram">
                                                </a>
                                                <a href="https://www.instagram.com" target="_blank"
                                                    class="social-icon mr-3">
                                                    <img src="{{ asset('assets/images/icons/Linkedin-2.svg') }}"
                                                        alt="Linkdin">
                                                </a>
                                                <a href="https://www.linkedin.com" target="_blank"
                                                    class="social-icon mr-3">
                                                    <img src="{{ asset('assets/images/icons/Tik Tok.svg') }}"
                                                        alt="tiktok">
                                                </a>
                                            </div>
                                        </div>
        ...
        document.addEventListener('DOMContentLoaded', function() {
            ...
            toggles.forEach(toggle => {
                toggle.addEventListener('click', function(event) {
                    ...
                    currentDetailsContent.style.display = currentDetailsContent.style.display ===
                        'none' ? 'table-row' : 'none';
                });
            });
        });
