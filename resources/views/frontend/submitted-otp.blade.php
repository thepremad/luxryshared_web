    ...
    <div class="container-fluid">
        <div class="row justify-content-center">
            <div class="col-lg-9 col-md-9 col-sm-9 col-9">
                <div class="sectionOtp-outer text-center">
                    <h2>Congratulations!!</h2>
                    <h4>Welcome to LXRY Shared</h4>
                    <h5>Your Ultimate Destination for Renting & Buying!</h5>
                    <p>We are absolutely thrilled to have you as a part of our growing community. Your decision to join us marks the 
                        beginning of an exciting journey where you empower the sharing economy and unlock the true value of your wardrobe.</p>
                    <button class="btn btn-primary mt-4 verifyBtn">Explore Website</button>
                </div>
            </div>                    
        </div>
    </div>
