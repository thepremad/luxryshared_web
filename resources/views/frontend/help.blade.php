...
@section('content')
        <div id="page-content" class="aboutUs faq help">
            <div class="container">
                <div class="aboutUs-Heading">
                    <h4>Help</h4>
                    <h5 class="text-center">Welcome to peer to peer marketplace</h5>
                    <div class="row helpForm-row justify-content-center align-items-center">
                        <div class="col-xl-7 col-lg-7 col-md-7 col-sm-7 col-10">
                ...
                <div class="faq-container mt-5">
                    <div class="row faq-contant mt-5">
                        ...
                        <a href="">
                            <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12 faqCard">
                                <h4>Resale</h4>
