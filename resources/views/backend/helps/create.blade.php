                        ...
                        <div class="breadcrumb-wrapper">
                            <ol class="breadcrumb">
                                ...
                                <li class="breadcrumb-item"><a
                                        href="{{ route('admin.helps.index') }}">helps</a>
                                </li>
                ...
                <div class="row">
                    <div class="col-12">
                        <div class="card">
                            ...
                            <div class="card-body">
                            {{ Form::model($helps, ['route' => ['admin.helps.store'], 'role' => 'form',
                              'id'=>'frmLogin', 'autocomplete'=>"off", 'method'=>'post','files' => true]) }}
                                    @csrf
                                    @if($helps->id)
                                      {!! Form::hidden('id', $helps->id) !!}
                                    @endif
                                    <div class="row">
                                        
                                        <div class="col-md-6 ">
                                        {!! Form::label('category_id', 'Category') !!}
                                        {!! Form::select('category_id', $categories->pluck('name','id'),$helps->category_id, ['class' => 'form-select
              ...
              success: function (res) {
                $('.spinner-loader').css('display', 'none');
                  if (res.status === 200) {
                      ...
                      window.location.href = "{{ route('admin.helps.index') }}"; 
