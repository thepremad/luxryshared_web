        ...
        <div class="content-header row">
            <div class="content-header-left col-md-9 col-12 mb-2">
                <div class="row breadcrumbs-top">
                    <div class="col-12">
                        <h2 class="content-header-title float-start mb-0">Press</h2>
                        <div class="breadcrumb-wrapper">
                            <ol class="breadcrumb">
                                <li class="breadcrumb-item"><a href="{{ route('admin.dashboard') }}">Home</a>
                                </li>
                                <li class="breadcrumb-item"><a
                                        href="{{ route('admin.presses.index') }}">presses</a>
                                </li>
                ...
                <div class="row">
                    <div class="col-12">
                        <div class="card">
                            ...
                            <div class="card-body">
                            {{ Form::model($presses, ['route' => ['admin.presses.store'], 'role' => 'form',
                              'id'=>'frmLogin', 'autocomplete'=>"off", 'method'=>'post','files' => true]) }}
                                    @csrf
                                    @if($presses->id)
                                      {!! Form::hidden('id', $presses->id) !!}
                                    @endif
                                    <div class="row">
                                        ...
                                        <div class="col-md-4 col-12">
                                            <div class="mb-1">
                                                <div class="d-flex flex-column">
                                                    ...
                                                    {!! Form::checkbox('status', '1', $presses->status == '1', ['class' => 'form-check-input', 'id' => 'customSwitch3']) !!}
                                                        </div>
                                            ...
                                            <div class="mb-1">
                                                ...
                                                @if($presses)
                                                <img width="100px" class="mt-1" src="{{url('public/uploads/presses/'.$presses->image)}}" alt="">
                                                @endif
                                            </div>
                                        </div>
              ...
              success: function (res) {
                $('.spinner-loader').css('display', 'none');
                  if (res.status === 200) {
                      ...
                      window.location.href = "{{ route('admin.presses.index') }}"; 
