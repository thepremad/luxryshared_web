        ...
        <div class="content-wrapper container-xxl p-0">
            <div class="content-header row">
                        ...
                        <div class="col-12">
                            ...
                            <div class="breadcrumb-wrapper"> 
                                <ol class="breadcrumb">
                                    ...
                                    <li class="breadcrumb-item"><a href="{{ route('admin.occasions.index') }}">Occasions</a>
                                    </li>
                ...
                <div class="col-md-3" style="text-align: end">
                    <a href="{{ route('admin.occasions.create') }}" class=" btn btn-primary btn-gradient round">Create</a>
                </div>
            </div>
                    ...
                    <div class="col-12">
                        <div class="card card-company-table">
                            ...
                            <div class="table-responsive" id="table-responsive">
                                    ...
                                    @php  $i = 1; @endphp
                                        ...
                                        @foreach ($occasion as $item)
                                            ...
                                            <tr>
                                                <td>{{$i }}</td>
                                                <td>
                                                <img src="{{ url('public/uploads/occasion/'.$item->image)}}" alt="Toolbar svg" height="50px" width="50px" />
                                                ...
                                                <td>
                                                    <div class="dropdown">
                                                        ...
                                                        <div class="dropdown-menu dropdown-menu-end">
                                                            <a class="dropdown-item" href="{{route('admin.occasions.edit',$item->id)}}">
                                ...
                                @include('backend._pagination', ['data' => $occasion])
                            </div>
                        </div>
                    </div>
                </div>
