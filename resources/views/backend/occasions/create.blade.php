                        ...
                        <div class="breadcrumb-wrapper">
                            <ol class="breadcrumb">
                                ...
                                <li class="breadcrumb-item"><a
                                        href="{{ route('admin.occasions.index') }}">Occasions</a>
                                </li>
                ...
                <div class="row">
                    <div class="col-12">
                        <div class="card">
                            ...
                            <div class="card-body">
                            {{ Form::model($occasion, ['route' => ['admin.occasions.store'], 'role' => 'form',
                              'id'=>'frmLogin', 'autocomplete'=>"off", 'method'=>'post','files' => true]) }}
                                    @csrf
                                    @if($occasion->id)
                                      {!! Form::hidden('id', $occasion->id) !!}
                                    @endif
                                    <div class="row">
                                        ...
                                        <div class="col-md-4 col-12">
                                            <div class="mb-1">
                                                <div class="d-flex flex-column">
                                                    ...
                                                    {!! Form::checkbox('status', '1', $occasion->status == '1', ['class' => 'form-check-input', 'id' => 'customSwitch3']) !!}
                                                        </div>
                                        ...
                                        <div class="col-md-8 col-12">
                                            <div class="mb-1">
                                                ...
                                                @if($occasion)
                                                <img width="100px" class="mt-1" src="{{url('public/uploads/occasion/'.$occasion->image)}}" alt="">
                                                @endif
                                            </div>
                                        </div>
              ...
              success: function (res) {
                $('.spinner-loader').css('display', 'none');
                  if (res.status === 200) {
                      ...
                      window.location.href = "{{ route('admin.occasions.index') }}"; 
