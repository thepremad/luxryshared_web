                ...
                <div class="row">
                    <div class="col-12">
                        <div class="card">
                            ...
                            <div class="card-body">
                            {{ Form::model($colors, ['route' => ['admin.colors.store'], 'role' => 'form',
                              'id'=>'frmLogin', 'autocomplete'=>"off", 'method'=>'post','files' => true]) }}
                                    ...
                                    <div class="col-md-1 mt-2 col-12">
                                            <div class="mb-1">
                                                        {!! Form::color('code', null,  ['class' => 'form-control', 'autocomplete'=>"off", 'id' =>
                                                          'colorPicker']) !!}
                                                </div>
                                        </div>
                                    <div class="col-md-7 col-12">
                                            <div class="mb-1">
                                                      {!! Form::label('code', 'Code') !!}
                                                        {!! Form::text('code', null,  ['class' => 'form-control','readonly', 'autocomplete'=>"off", 'id' =>
                                                          'colorCode']) !!}
