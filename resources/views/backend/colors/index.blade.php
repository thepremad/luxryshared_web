            ...
            <div class="content-header row">
                <div class="content-header-left col-md-9 col-12 mb-2">
                    <div class="row breadcrumbs-top">
                        <div class="col-12">
                            <h2 class="content-header-title float-start mb-0">Color</h2>
                            <div class="breadcrumb-wrapper">
                                <ol class="breadcrumb">
                                    <li class="breadcrumb-item"><a href="{{  route('admin.dashboard') }}">Home</a>
                                    </li>
                                    <li class="breadcrumb-item"><a href="{{ route('admin.colors.index') }}">Colors</a>
                                    </li>
                ...
                <div class="col-md-3" style="text-align: end">
                    <a href="{{ route('admin.colors.create') }}" class=" btn btn-primary btn-gradient round">Create</a>
                </div>
            </div>
...
<script>
    ...
    $(document).on('click', '.delete-record', function () {
            ...
            if (confirm('Are you sure you want to delete this categories ?')) {
                $.ajax({
                    url: "{{ url('admin/colors') }}/" + associateId, // Use the url() function
                    type: 'DELETE',
                    data: {
